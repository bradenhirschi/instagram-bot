 ...
 * @since 0.2.0
 */
export declare abstract class AbstractGetMediaInsightsRequest<T extends SimplePostMetric | StoryMetric | AlbumMetric> extends AbstractRequest<GetMediaInsightsResponse> {
    /**
     * The media object id.
     */
