 ...
 * @since 2.0.0
 */
export declare class GetAuthorizedFacebookPagesResponse extends AbstractResponse<AuthorizedFacebookPagesData> {
    /**
     * Gets the page id of the user that made the request.
     *
     * @returns the page id of the user that made the request.
     */
    getAuthorizedFacebookPages(): Array<FacebookPage>;
}
