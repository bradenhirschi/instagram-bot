 ...
 * @since 1.1.0
 */
export declare class PostPagePhotoMediaRequest extends AbstractPostPageTimelineMediaRequest {
    /**
     * The constructor
     *
     ...
     */
    constructor(accessToken: string, pageId: string, imageUrl: string, caption?: string, locationId?: string, userTags?: UserTag[], isCarousel?: boolean);
    /**
     ...
     */
    withUserTags(userTags: UserTag[]): PostPagePhotoMediaRequest;
    /**
     ...
     * @returns this object, for chained invocation.
     */
    withIsCarousel(isCarousel: boolean): PostPagePhotoMediaRequest;
    /**
     * @inheritdoc
     */
